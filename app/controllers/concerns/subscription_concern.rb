module SubscriptionConcern
    ...
    included do
        ...
        def active_subscription
            check_subscription_status if subscription_end_date.nil? || subscription_end_date < 15.days.from_now #Time.now 
            
            subscription_end_date.nil? ? false : subscription_end_date > 15.days.from_now #Time.now 
        end
    end
end