...
def seed_users
    jane = User.create(email: 'jane@seed.com',
                        password: '123456',
                        password_confirmation: '123456',
                        first_name: 'Jane',
                        last_name: 'Doe',
                        role: User.roles[:admin])
    john = User.create(email: 'john@seed.com',
                        password: '123456',
                        password_confirmation: '123456',
                        first_name: 'John',
                        last_name: 'Doe')
...
def seed_categories
    ...
    Category.create(name: "Rugby", display_in_nav: true)
    Category.create(name: "Hockey", display_in_nav: true)
    Category.create(name: "Entrenadores", display_in_nav: false)
end
