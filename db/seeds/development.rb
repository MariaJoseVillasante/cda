...
Category.first_or_create!(name:"Rugby", display_in_nav: true)
Category.first_or_create!(name:"Hockey", display_in_nav: true)
Category.first_or_create!(name:"Entrenadores", display_in_nav: false)
